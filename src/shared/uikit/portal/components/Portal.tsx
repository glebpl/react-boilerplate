 ...
 */
const zIndexToName: Record<number, Layers> = Object.keys(layers).reduce<Record<number, Layers>>((acc, name) => {
...
const getLayerName = (zIndex: number): Layers | null =>
  Object.prototype.hasOwnProperty.call(zIndexToName, zIndex) ? zIndexToName[zIndex] : null;

const getEvent = (eventName: string, zIndex: number): CustomEvent<PortalEventDetail> => {
